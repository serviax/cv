...
experiencesRouter.get('/:lang', jwt({ secret: secretCallback, algorithms: ['HS256'] }), asyncHandler(async (request, response) => {
...
experiencesRouter.post('/', jwt({ secret: secretCallback, algorithms: ['RS256'] }), asyncHandler(async (request, response): Promise<any> => {
